...
import ServerDiscover from '../ServerDiscover';


function ServerDiscoverModal() {
    const [showModal, setShowModal] = useState(false);

    return (
        <>
        <div className='serverListItem' id="join-server-button" onClick={() => setShowModal(true)}>
...
export default ServerDiscoverModal;